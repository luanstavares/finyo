...
const buttonVariants = cva(
    cn(
        ...
        Platform.select({
            web: "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive focus-visible:ring-ring/50 whitespace-nowrap outline-none transition-all focus-visible:border-ring focus-visible:ring-[3px] disabled:pointer-events-none [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0"
        })
    ),
    {
        variants: {
            variant: {
                default: cn(
                    "active:bg-primary/90 bg-primary dark:active:bg-input/50 shadow-sm shadow-black/5",
                ...
                ghost: cn(
                    ...
                    Platform.select({
                        web: "dark:hover:bg-accent/50 hover:bg-accent"
                    })
                ),
                link: ""
            },
