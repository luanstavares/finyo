...
- If no suitable utility exists in either place, create a new reusable utility in `@/utils/utils.ts` with a clear, related file name, then import and use it where needed.
